...
{ plumbing()
 ...
 zen::quix_behaviour_event_publish< uint64_t >;
        zen::quix_memory_local quix_behaviour_memory( 1048576 );
        quix_behaviour_type behaviour( quix_behaviour_memory.data(), 1 );

    using quix_node_injector_type =
 zen::quix_node_injector< transport_type, quix_behaviour_type >;
 ...
 zen::quix_behaviour_event_publish< uint64_t >;
    ...
    using quix_node_injector_type =
 zen::quix_node_injector< transport_type, quix_behaviour_type >;
    auto quix_node_injector =
 std::make_quix_memory_shared< quix_node_injector_type >( transport, behaviour );}}
plumbing;
///
///////////////////////////////////////////////////////////////////////////////////////////////////
///
