...
///////////////////////////////////////////////////////////////////////////////////////////////////
//
#include <zen/quix/node/quix_node_processor.cpp>
...
#include <zen/quix/behaviour/quix_behaviour_event_republish.cpp>
#include <memory>
#include <cstring>
//
///////////////////////////////////////////////////////////////////////////////////////////////////
...
struct plumbing
{
  ...
  void structors_stack()
  {
    ...
    using quix_behaviour_type = zen::quix_behaviour_event_republish< uint64_t >;
        zen::quix_memory_local quix_behaviour_memory( 1048576 );
        quix_behaviour_type behaviour( quix_behaviour_memory.data(), 1 );

    using quix_node_processor_type = zen::quix_node_processor< transport_type, quix_behaviour_type >;
    quix_node_processor_type quix_node_injector( transport, behaviour );
  }
  ...
  void structors_heap()
  {
    ...
    using quix_node_processor_type = zen::quix_node_processor< transport_type, quix_behaviour_type >;
    auto quix_node_processor = std::make_quix_memory_shared< quix_node_processor_type >( transport, behaviour );
  }
}
plumbing;
//
