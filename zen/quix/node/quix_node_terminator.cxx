...
struct plumbing
{
  ...
  void structors_stack()
  {
    ...
    using quix_behaviour_type = zen::quix_behaviour_event_consume< uint64_t >;
        zen::quix_memory_local quix_behaviour_memory( 1048576 );
        quix_behaviour_type behaviour( quix_behaviour_memory.data(), 1 );

    using quix_node_terminator_type = zen::quix_node_terminator< transport_type, quix_behaviour_type >;
  ...
  void structors_heap()
  {
    ...
    using quix_node_terminator_type = zen::quix_node_terminator< transport_type, quix_behaviour_type >;
    auto quix_node_terminator = std::make_quix_memory_shared< quix_node_terminator_type >( transport, behaviour );
  }
}
plumbing;
//
