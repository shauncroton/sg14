...
///
template< typename E >
zen::quix_behaviour_event_consume< E >::impl::impl( const unsigned int loops_arg )
    : loops_mem( loops_arg )
{}
...
template< typename E >
void
zen::quix_behaviour_event_consume< E >::impl::operator()( event_type &event )
{
    if( event != loops_mem )
...
template< typename E >
void
zen::quix_behaviour_event_consume< E >::operator()( event_type &event )
...
template< typename E >
std::string
to_string( const zen::quix_behaviour_event_consume< E > &quix_behaviour_event_consume_arg )
{
