...
//
template< typename E >
zen::quix_behaviour_event_republish< E >::impl::impl(
...
template< typename E >
void
zen::quix_behaviour_event_republish< E >::impl::operator()(
    event_type &event
)
{
    if( event != loops_mem )
...
template< typename E >
void
zen::quix_behaviour_event_republish< E >::operator()(
    event_type &event
)
{
...
std::string
to_string(
    const zen::quix_behaviour_event_republish< E > &quix_behaviour_event_republish_arg
)
{
