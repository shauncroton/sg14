...
//
template< typename E >
zen::quix_behaviour_file_write< E >::impl::impl(
...
template< typename E >
void
zen::quix_behaviour_file_write< E >::impl::operator()(
    event_type &event
)
{
...
template< typename E >
void
zen::quix_behaviour_file_write< E >::operator()(
    event_type &event
)
{
...
std::string
to_string(
    const zen::quix_behaviour_file_write< E > &quix_behaviour_file_write_arg
)
{
