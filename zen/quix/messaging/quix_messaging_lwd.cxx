...
struct plumbing
{
  ...
  using transport_type = zen::quix_messaging_lwd< event_type >;
  char data[ 65536 ];
  ...
  void structors_heap()
  {
    ...
    auto quix_messaging_lwd1 = std::make_quix_memory_shared< transport_type >( (void*)data, 2, follow_list_type( { 1 } ) );
  }
}
plumbing;
//
...
struct scenarios
{
  using transport_type = zen::quix_messaging_lwd< uint64_t >;
  ...
  void basic_three_stage_sequence_with_batching()
    ...
    uint64_t &value11 = quix_node_injector.aquire();
    value11 = 11;

    uint64_t &value12 = quix_node_injector.aquire();
    value12 = 12;

    uint64_t &value13 = quix_node_injector.aquire();
    value13 = 13;
    ...
    uint64_t &value21 = quix_node_processor.reaquire();
    CHECK( value11 == value21 );
        value21 = 21;

    uint64_t &value22 = quix_node_processor.reaquire();
    CHECK( value12 == value22 );
        value22 = 22;

    uint64_t &value23 = quix_node_processor.reaquire();
    ...
    uint64_t &value31 = quix_node_terminator.reaquire();
    CHECK( value21 == value31 );

    uint64_t &value32 = quix_node_terminator.reaquire();
    CHECK( value22 == value32 );

    uint64_t &value33 = quix_node_terminator.reaquire();
