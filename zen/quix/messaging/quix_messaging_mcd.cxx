...
struct plumbing
{
  ...
  using transport_type = zen::quix_messaging_mcd< event_type >;
  char meta[ 65536 ];
  ...
  void structors_heap()
  {
    ...
    auto quix_messaging_mcd1 = std::make_quix_memory_shared< transport_type >( (void*)meta, 2,    follow_list_type( { { 1, 1 } } ) );
        auto quix_messaging_mcd2 = std::make_quix_memory_shared< transport_type >( (void*)meta, 2, 4, follow_list_type( { { 1, 4 } } ) );
  }
}
plumbing;
//
...
struct scenarios
{
  using transport_type = zen::quix_messaging_mcd< int >;
  ...
  void basic_three_stage_sequence()
    ...
    CHECK( quix_node_injector.aquire_test() == true );
    CHECK( quix_node_injector.reaquire_test() == false );
    ...
    int &value1 = quix_node_injector.aquire();
    CHECK( quix_node_injector.aquire_test() == false );
    ...
    CHECK( quix_node_processor.aquire_test() == false );
    CHECK( quix_node_processor.reaquire_test() == true );
    ...
    int &value2 = quix_node_processor.reaquire();
    CHECK( quix_node_processor.reaquire_test() == false );
    ...
    CHECK( quix_node_terminator.aquire_test() == false );
    CHECK( quix_node_terminator.reaquire_test() == true );
    ...
    int &value3 = quix_node_terminator.reaquire();
    CHECK( quix_node_terminator.reaquire_test() == false );
  ...
  void basic_quix_messaging_dual_channel_cross_sequence()
    ...
    // Thru channel 1
        {
    CHECK( quix_node_injector11.aquire_test() == true );
    int &value1 = quix_node_injector11.aquire();
    value1 = 11;
    int *value1addr = &value1;
    quix_node_injector11.commit();

    CHECK( quix_node_processor3x.reaquire_test() == true );
    int &value2 = quix_node_processor3x.reaquire();
    CHECK( value1 == value2 );
    int *value2addr = &value2;
    CHECK( value1addr == value2addr );
        value2 = 21;
    ...
    CHECK( quix_node_terminator41.reaquire_test() == true );
    int &value3 = quix_node_terminator41.reaquire();
    CHECK( value2 == value3 );
    int *value3addr = &value3;
    CHECK( value2addr == value3addr );
    ...
    // Thru channel 2
        {
    CHECK( quix_node_injector22.aquire_test() == true );
    int &value1 = quix_node_injector22.aquire();
    value1 = 12;
    int *value1addr = &value1;
    ...
    CHECK( quix_node_terminator52.reaquire_test() == true );
    int &value3 = quix_node_terminator52.reaquire();
    CHECK( value2 == value3 );
    int *value3addr = &value3;
    CHECK( value2addr == value3addr );
