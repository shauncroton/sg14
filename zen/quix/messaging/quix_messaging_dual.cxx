...
struct plumbing
{
  ...
  using transport_type = zen::quix_messaging_dual< event_type >;
  char data[ 65536 ];
  ...
  void structors_heap()
  {
    ...
    auto quix_messaging_dual1 = std::make_quix_memory_shared< transport_type >( (void*)data, 1, follow_list_type( { 2 } ) );
  }
}
plumbing;
//
...
struct scenarios
{
  using transport_type = zen::quix_messaging_dual< uint64_t >;
