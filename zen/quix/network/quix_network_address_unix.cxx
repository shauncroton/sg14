...
{ plumbing()
  ...
  { std::string address_arg( "/tmp/quix_network_address_unix_test.quix_messaging_unix" );
        auto address =
 std::make_quix_memory_shared< zen::quix_network_address_unix >( address_arg );}}
plumbing;
///
///////////////////////////////////////////////////////////////////////////////////////////////////
///
...
{ api()
 ...
 reinterpret_cast< struct sockaddr& >( sa ).sa_family );
    const struct sockaddr_un *address_ptr =
 reinterpret_cast< const struct sockaddr_un* >( address.addr() ) ;
    CHECK( address_ptr->sun_family ==
 sa.sun_family );
    CHECK( std::strcmp( address_ptr->sun_path, sa.sun_path ) ==
 0 );}
