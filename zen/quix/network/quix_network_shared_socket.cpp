...
///////////////////////////////////////////////////////////////////////////////////////////////////
//
zen::quix_network_shared_socket::impl::impl(
...
zen::quix_network_shared_socket::quix_network_shared_socket(
    ...
    : pimpl(
    new impl(
        listening_quix_messaging_unix_arg
    ))
{
    return;
}
...
zen::quix_network_shared_socket::operator()()
{
    return std::make_shared< socket_type >(
        pimpl->connected_quix_messaging_unix.recv_fd_checked(
            0xCAFEBABEDEADBEEF
        ));
}
...
std::string
to_string(
    const zen::quix_network_shared_socket &quix_network_shared_socketarg
)
{
