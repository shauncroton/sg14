...
struct plumbing
{
  static
  void
  connection_quix_messaging_unix_fn(
  ...
  void structors_stack()
  {
    ...
    std::thread fd_receiver_thread( 
      plumbing::connection_quix_messaging_unix_fn,
    ...
    address addr_fd_listener;
     zen::quix_network_shared_listener listening(
  ...
  void structors_heap()
  {
    ...
    address addr_fd_listener;
     auto listening = std::make_quix_memory_shared< zen::quix_network_shared_listener >(
      addr_fd_listener.any(),
      addr_fd_receiver.quix_messaging_unix(),
      addr_fd_sender.quix_messaging_unix()
      );
